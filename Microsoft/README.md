...
Seven collectors spanning Azure and Microsoft 365. Each authenticates via a Service Principal or registered app, fetches the last 24 hours of service activity, and generates a CycloneDX 1.6 Bill of Materials report.
...
| [Azure SQL Database](Azure%20SQL%20Database/) | SQL servers and databases across all subscriptions; describes SKU tier, collation, max size, zone redundancy, HA replicas, backup storage redundancy; activity logs via Azure Monitor |
...
| Azure SQL Database | `AZURE_SQL_TENANT_ID`, `AZURE_SQL_CLIENT_ID`, `AZURE_SQL_CLIENT_SECRET` |
